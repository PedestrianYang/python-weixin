...
def save_file(this_download_url,path):
    ...
    if (os.path.isfile(path)):
        ...
        print
        "File "+path+" ("+ str(file_size)+"Mb) already exists."
        return
    else:
        print
        "Downloading "+path+"..."
...
def download_url(website_url):
    try:
        ...
        req = urllib.request.Request(website_url,headers=fuckyou_header)
    ...
    print
    "Web page all length:" +str(len(content))
